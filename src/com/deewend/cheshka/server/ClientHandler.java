...
import static com.deewend.cheshka.server.Helper.getClassName;
...
public class ClientHandler implements Runnable {
    ...
    private void run0() throws IOException {
        ...
        if (clientHello.protocolVersion != Helper.SERVER_VERSION_CODE) {
            ...
            String message;
            if (less) message = "Outdated client, please update to 1.2";
            else      message = "Outdated server, please downgrade to 1.2";
